            ...
            <input type=submit name=action value=löschen />
                ...
                <h3>Geburtstag</h3>
                    ...
                    <select name="handwerk1" value="">
                        ...
                        <option
                        <?php 
                        if ($row[0]->handwerk1 == "Rüstungsschmied") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Rüstungsschmied</option>
                        <option
                        <?php 
                        if ($row[0]->handwerk1 == "Waffenschmied") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Waffenschmied</option>
                        <option
                        <?php 
                        if ($row[0]->handwerk1 == "Waidmann") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Waidmann</option>
                        <option
                        <?php 
                        if ($row[0]->handwerk1 == "Konstrukteur") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Konstrukteur</option>
                    ...
                    <br> <select name=handwerk2 value="">
                        ...
                        <option
                        <?php 
                        if ($row[0]->handwerk2 == "Rüstungsschmied") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Rüstungsschmied</option>
                        <option
                        <?php 
                        if ($row[0]->handwerk2 == "Waffenschmied") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Waffenschmied</option>
                        ...
                        <option
                        <?php 
                        if ($row[0]->handwerk2 == "Konstrukteur") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Konstrukteur</option>
                        <option
                        <?php 
                        if ($row[0]->handwerk2 == "Juwelier") {
                            echo "selected='selected'"; 
                        }
                        ?>
                        >Juwelier</option>
                    </select> Stufe <input type=number value="<?php echo $row[0]->handwerk2stufe;?>" name="handwerk2stufe" />
                    
                    <h3>Spielzeit</h3>
                    <input type=number name=stunden value="<?php echo $row[0]->spielstunden; ?>" />
                    <?php echo " (in Stunden)"; ?>
                    <br>
                    ...
                    <div class="innerBody">
                        ...
                        Klasse
                            ...
                            <option 
                            <?php 
                            if ($row[0]->klasse == "Elementarmagier") { 
                                echo "selected='selected'"; 
                            }
                            ?> 
                            >Elementarmagier</option>
                            <option 
                            <?php 
                            if ($row[0]->klasse == "Nekromant") { 
                                echo "selected='selected'"; 
                            }
                            ?> 
                            >Nekromant</option>
                ...
                <br> <br> <br><br> <br>
                <h3>Notizen</h3>
                <textarea class='ckeditor' id='charNotizen' name='charNotizen'>
                    <?php echo $row[0]->notizen; ?> 
                </textarea>
            </div>
            </form>
            </div>
