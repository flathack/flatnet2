...
<div id="wrapper">
    ...
    <head>
        ...
        <title>flatnet2 - Dokumenation</title>
    </head>
    ...
    <body>
        ...
        <div class='newFahrt'>
            ...
            <h1>Dokumentation</h1>
            <p>Die Dokumentation beschreibt alle Funktionen und Methoden des Projekts Flatnet2, programmiert von Steven S.
                im Zeitraum 2013 bis 2018.</p>
            <div class="publicInfo">
                <h1>
                    <?php echo $counter; $counter++; ?> Programmierung
                </h1>
                ...
                <div id="addpage" style="display:none;">
                    ...
                    <p>Das Kapitel Programmierung befasst sich mit der Erstellung neuer Abschnitte, Aufteilung des Projekts
                        und andere wichtige Informationen, zum programmieren dieser Webseite.</p>
                    ...
                    <ul>
                        ...
                        <li>In diesem Ordner eine index.php erstellen und mit einem Standard-Layout versehen (includes/standardindex.php).
                            </li>
                        <li>Eine Class-Datei erstellen im Ordner "include", z. B. amazon.class.php. Hier die class amazon
                            erstellen, diese wird als child von functions deklariert (extends functions). Dazu noch ein include
                            'objekt/functions.class.php' und das wars.</li>
                    </ul>
                    <h4>Rechte</h4>
                    <ul>
                        <li>Entweder&uuml;ber PHPMYADMIN oder die Objekte-Verwaltung eine neue Kategorie f&uuml;r den neuen
                            Bereich erstellen.</li>
                    ...
                    <ul>
                        <li>in der CSS m&uuml;ssen verscheidene Anpassungen gemacht werden: Einmal ab ca. Zeile 250 die Anpassung
                            an "#uebersicht #uebersicht" (muss dem Seitenheader der Standardindex.php entsprechen</li>
                        <li>Dann in der CSS ab Zeile 350 folgende Zeilen hinzuf&uuml;gen .bereichfahrten h2, .bereichfahrten
                            p,</li>
                        <li>In der CSS eine eigene .bereich<strong>fahrten</strong> (beispiel) erstellen. Jetzt ist die CSS
                            Anpassung abgeschlossen</li>
                    </ul>
                    <h4>Datenbank</h4>
                    <ul>
                        ...
                        <li>in der includes/control.class.php in Zeile 369 in der Funktion
                            ...
                            Dies ist dann der Fall, wenn ein Benutzer eigene Eintr&auml;ge hinzuf&uuml;gen kann, z. B. neue
                            Guildwars Charakter. Diese k&ouml;nnen dem Benutzer direkt zugeordnet werden! Dies ist wichtig,
                            damit die Eintr&auml;ge nachher von jedem Benutzer wieder vom Adminpanel gel&ouml;scht werden
                            k&ouml;nnen.</li>
                    </ul>
                    <h4>&Uuml;bersichtsseite</h4>
                    <ul>
                        <li>Auf der&uuml;bersichtsseite eine Kachel f&uuml;r den Bereich hinzuf&uuml;gen. Hier ist die CSS
                            Klasse des Bereichs sowie die Rechte ID auszuw&auml;hlen.</li>
                    </ul>
                </div>
            </div>
            <div class="publicInfo">
                <h1>
                    <?php echo $counter; $counter++; ?> Administration
                </h1>
                ...
                <div id="administration" style="display:none;">
                    ...
                    <p>Die Benutzerverwaltung erm&ouml;glicht das erstellen, bearbeiten und konfigurieren der Benutzer der
                        Seite.</p>
                    <h3>2.2 Logs</h3>
                    <p>Auf der Unterseite Logs sind verschiedene Log-Eintr&auml;ge zu sehen. Unterschieden wird hier zwischen
                        einer SQL-Query Log und einer vorschlaege log. Die Vorschlaege k&ouml;nnen von den Benutzern der
                        Seite an den Administrator gesendet werden. Das Vorschl&auml;ge-Log ist sozusagen, der Helpdesk dieser
                        Webseite.</p>
                    <p>Da drunter ist eine Tabelle, in welcher angezeigt wird, wann sich welcher Benutzer das letzte mal
                        eingeloggt hat. Dies wird nach Benutzer gruppiert. Es wird also immer der letzte Login angezeigt.
                        Auf der Datenbank sind aber alle Logins zu erkennen.</p>
                    <p>Dann gibt es noch ein SQL-Log. Hier werden alle inserts,updates,deletes der Seite gespeichert. Unterschieden
                        wird hier zwischen den verschiedenen Benutzern. Sortierung erfolgt nach Datum und Uhrzeit.</p>
                    <h3>2.3 Objekte</h3>
                    <p>Die Seite Objekte zeigt eine Miniaturversion der phpmyadmin Seite an. Hier k&ouml;nnen einzelne Eintr&auml;ge
                        der Datenbank angezeigt, bearbeitet oder gel&ouml;scht werden. </p>
                    <h3>2.4 Forum</h3>
                    <p>Die Forumadministration erm&ouml;glicht die Erstellung und Bearbeitung von KAtegorien f&uuml;r die
                        Forum-Sektion der Webseite. Auch Rechte k&ouml;nnen f&uuml;r jede Sektion an die Benutzer verteilt
                        werden. Dabei wird das 2er Potenz Rechtesystem verwendet. Es ist daher wichtig, dass der vorgeschlagene
                        Potenzwert beibehalten wird. Sonst kann es zu Dopplungen innerhalb des Rechtesystems kommen.</p>
                    ...
                    <p>Der Bereich Ank&uuml;ndigungen erm&ouml;glicht die Erstellung von Ank&uuml;ndigungen f&uuml;r den
                        Header-Bereich der Webseite.</p>
                </div>

            </div>
            <div class="publicInfo">
                <h1>
                    <?php echo $counter; $counter++; ?> Adressbuch
                </h1>
            ...
            <div class="publicInfo">
                <h1>
                    <?php echo $counter; $counter++; ?> Forum
                </h1>
            ...
            <div class="publicInfo">
                <h1><a name="finanzen">
                        <?php echo $counter; $counter++; ?> Finanzverwaltung</a></h1>
                <p class="einleitung">Die Finanzverwaltung erm&ouml;glicht eine &uuml;bersichtliche Darstellung seiner eigenen
                    Konten und der zuk&uuml;nftigen Finanzplanung. Das Grundprinzip ist die Schaffung einer Soll und Haben
                    Seite eines jeden Kontos.</p>
                ...
                <div id="finanzen" style="display:none;">
                    ...
                    <p>Die Startseite zeigt eine &Uuml;bersicht aller aktiven Konten an. Bei einem Klick auf ein aktives
                        Konto, werden die Ums&auml;tze des aktuellen Monats im aktuellen Jahr angezeigt. &Uuml;ber die Navigation
                        kann die Ansicht in auf Monate ver&auml;ndert werden. Zudem kann von jeder Position aus ein anderes
            ...
            <div class="publicInfo">
                <h1>
                    <?php echo $counter; $counter++; ?> Guildwars
                </h1>
                ...
                <div id="guildwars" style="display:none;">
                    ...
                    <p>Der Guildwars-Bereich erm&ouml;glicht eine Ansicht und Auswertung seiner eigenen Charakter. Die Hauptfunktion
                        ist allerdings die Eingabe von Daten in das Handwerksfeld. Hier k&ouml;nnen die bestehenden Daten
                        dazu genutzt werden ben&ouml;tigte Rohstoffe, f&uuml;r das erlernen der Handwerksberufe, zu sehen.</p>
            ...
            <div class="publicInfo">
                <h1>
                    <?php echo $counter; $counter++; ?> Benutzerprofil
                </h1>
                ...
                <div id="profil" style="display:none;">
                    ...
                    <p>Um ein Passwort zu ändern, klicken Sie rechts oben auf Ihren Namen. Im oberen Bereich der Webseite
                        klicken Sie nun auf "Benutzereinstellungen". Hier können Sie Ihr Passwort &auml;ndern.
                    </p>
                </div>
            </div>
    </body>
