...
class FinanzenNEW extends functions
{
    ...
    /**
     * L�scht markierte Zeilen / Ums&auml;tze in der showWholeYear Funktion
     */
    ...
    function showKontenInSelect($besitzer) {
        ...
        # �berpr�fen, ob der Nutzer konten hat (Update vom 11.08.2017)
    ...
    /**
     * Bucht meherere Ums�tze um. Hierf�r wird der POST Befehl und die Checkboxen verwendet.
     * @param unknown $besitzer
     */
           ...
           if($von > 0 AND $nach > 0) {
               ...
               if($von == $nach) {
                   ...
                   foreach ($buchungsnummern as $buchungsnummer) {
                       ...
                       # Info �ber diese Buchung bekommen:
                       ...
                       for($i = 0; $i < sizeof ( $getBuchungInfos ); $i ++) {
                           ...
                           if ($getBuchungInfos [$i]->umsatzWert > 0) {
                               ...
                               if ($this->sql_insert_update_delete($update) == true) {
                                   echo "<p class='erfolg'>Umbuchung f�r $buchungsnummer erfolgt</p>";
                               } else {
                                   echo "<p class='meldung'>Es gab einen Fehler.</p>";
                               }
                           }
    ...
    /**
     * Zeigt eine Auswahl zum Ändern deiner Buchungsnummer bez&uuml;gl.
    ...
    /**
     * Gibt den Kontonamen einer ID zur�ck.
    ...
    /**
     * Überpr&uuml;ft alle Jahresabschl&uuml;sse auf Richtigkeit und l&ouml;scht diese, fall n&ouml;tig.
