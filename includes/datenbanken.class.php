 ...
 * @author Steven
 * Ermφglicht die Funktionen des Adressbuches.
 */
include 'objekt/functions.class.php';
class datenbanken extends functions {
	
	/**
	 * ermφgtlicht das exportieren von Dateien, wenn όber GET die Zahl 1 angegeben wird und der User Steven ist.
 ...
 */
	...
	/**
	 * Ermφglicht das Updaten der Informationen zu einem Eintrag im Adressbuch.
	 * Benφtigt GET Var "update" == "Speichern".
	 */
	...
	/**
	 * Ermφglicht das lφschen von Datensδtzen aus dem Adressbuch.
	...
	/**
	 * Ermφglicht das eintragen von Datensδtzen zum Adressbuch in die Datenbank, die
	 * nφtigen GET Vars liefert UserErstellenEingabe();
	 */
	...
	/**
	 * lieίt alle eingetragenen Datensδtze aus dem Adressbuch aus.
