...
class Lotto
{
     ...
     * @return boolean
     */
    public function habichgewonnen($meineZahl, $von, $bis)
    {
     ...
     * @return boolean
     */
    public function lottoAbfrage($meineLottoZahlen, $bis, $richtige)
    {
     ...
     */
    public function einfachesLotto()
    {
     ...
     */
    public function additionBisHundert()
    {
